...
class StanfordCoreNLP:
    ...
    def _spawn_corenlp(self):
        ...
        self.corenlp = pexpect.spawn(self.start_corenlp, timeout=360, maxread=8192, searchwindowsize=80)
    ...
    def __init__(self, corenlp_path=DIRECTORY, memory="2g", properties='default.properties', serving=False):
        """
        Checks the location of the jar files.
        Spawns the server as a process.
        """
